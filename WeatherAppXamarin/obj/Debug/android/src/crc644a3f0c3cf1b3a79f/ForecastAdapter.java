...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("WeatherAppXamarin.Adapters.ForecastAdapter, WeatherAppXamarin", ForecastAdapter.class, __md_methods);
	}
	...
	public ForecastAdapter ()
	{
		...
		if (getClass () == ForecastAdapter.class) {
			mono.android.TypeManager.Activate ("WeatherAppXamarin.Adapters.ForecastAdapter, WeatherAppXamarin", "", this, new java.lang.Object[] {  });
		}
	}
